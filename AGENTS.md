...
**Rebuild the distributed ZIP** (`make build-claude-skill`, runs `skill/build-zip.sh`, output `skill/pprof-analyzer-skill.zip`, git-ignored) after changing any `skill/<name>/` file, a `SKILL.md`, or `action/pprof_integration.md`.
